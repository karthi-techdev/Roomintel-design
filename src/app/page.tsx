...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      text: "Amazing service and great ambience.",
      name: "Berber Smith",
    ...
    },
    {
      ...
      text: "Very clean rooms and friendly staff.",
      name: "John David",
    ...
    },
    {
      id: 3,
      title: "Loved It",
      text: "Best resort experience so far.",
      name: "Sophia Lee",
    ...
    },
    {
      ...
      text: "Peaceful location and luxury feel.",
      name: "Michael Roy",
  ...
  const CARD_WIDTH = 100 / 3; // 3 cards visible
  const translateX = `-${startIndex * (100 / cardsPerView)}%`;
  ...
  "
      >
        <section className="bg-white py-10 lg:px-25 sm:py-12 md:py-14 lg:py-20 rounded-[10px] md:px-5">
          ...
          <div className="overflow-hidden w-full">
            ...
            <div className="mb-16 max-w-4xl ml-5 md:ml-0">
              ...
              <h2 className="text-4xl md:text-[3.5rem] font-serif text-[#283862] font-bold mb-6">
        ...
        "
                >
                  <div className="bg-[#F9F9F9] p-8 sm:p-10 md:p-14 border border-gray-100/50">
                    <div className="text-[#c23535] text-4xl mb-6">
                      <RiDoubleQuotesL />
                    </div>
                    ...
                    <span className='mb-8 flex text-[#ffa50091]'><FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfStroke/></span>
