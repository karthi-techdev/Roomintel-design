...
const Dashboard: React.FC<DashboardProps> = ({ onBack, onLogout }) => {
  ...
  const user = {
    ...
    address: "2624 Sampson Street, Aurora, CO 80014",
                                ...
                                <div className="flex flex-col md:flex-row gap-6 md:items-center">
                                    <div className="flex-1">
                                        <div className="flex justify-between text-xs font-bold uppercase tracking-wider mb-2">
                                            ...
                                            <span className="text-[#283862]">2,450 / 5,000</span>
                                        </div>
                                        <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                                            <div className="h-full bg-gradient-to-r from-[#283862] to-[#c23535] w-[49%]"></div>
                                        </div>
                                        <p className="text-xs text-gray-400 mt-2">Earn 2,550 more points to reach Platinum status.</p>
                                    </div>
