...
//                                     <button  className="w-full py-4 cursor-pointer bg-gradient-to-r from-[#283862] to-[#1c2a4a] hover:from-[#c23535] hover:to-[#a82d2d] text-white font-bold text-sm uppercase tracking-wider rounded-lg transition-all duration-300 shadow-md hover:shadow-lg">
//                                         Proceed to Checkout
//                                     </button>
//                                 </div>
//                             </div>
...
//                 {/* REMOVED: Mobile Summary Section - This was the duplicate summary at the bottom */}

//                 {/* Bottom Actions - Desktop only */}
//                 <div className="hidden lg:flex mt-8 flex-col sm:flex-row justify-between items-center gap-4">
//                     <button className="px-6 py-3 cursor-pointer border border-gray-300 text-gray-700 rounded-lg hover:border-[#c23535] hover:text-[#c23535] transition-colors font-medium">
//                         Continue Shopping
//                     </button>
...
//                             Update Cart
//                         </button>
//                         <button className="px-6 py-3 cursor-pointer bg-[#c23535] text-white rounded-lg hover:bg-[#a82d2d] transition-colors font-medium flex items-center gap-2">
//                             <FaCreditCard />
//                             Secure Checkout
//                         </button>
//                     </div>
