...
//       {/* --- HEADER --- */}
//       <div className="relative bg-gradient-to-br from-[#283862] to-[#1c2a4a] pt-32 pb-20 text-white text-center overflow-hidden">
...
//           </h1>
//           <div className="flex justify-center items-center gap-3 text-sm font-medium tracking-wider uppercase">
//             <span className="hover:text-[#c23535] cursor-pointer transition-colors" onClick={onBack}>
//               Home
//             </span>
//             <span>/</span>
...
//                           paymentMethod === method.id ? 'border-[#c23535]' : 'border-gray-300'
//                         }`}>
//                           {paymentMethod === method.id && (
