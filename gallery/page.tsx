...
const Gallery: React.FC<GalleryProps> = ({ onBack }) => {
  ...
  const categories = ['All', 'Spaces', 'Activities', 'Pools', 'Restaurants', 'Spaa'];
  ...
  const images = [
    ...
    {
      id: 4,
      src: "https://images.unsplash.com/photo-1571896349842-6e53ce41e887?q=80&w=1200&auto=format&fit=crop",
      category: "Pools",
    ...
    <div className="bg-[#FAFAFA] w-full font-sans pb-20 min-h-screen">
      ...
      <div className="bg-[#283862] pt-40 pb-24 text-white text-center px-4 relative overflow-hidden">
         <div className="absolute inset-0 opacity-40">
             <img src="https://images.unsplash.com/photo-1571896349842-6e53ce41e887?q=80&w=2670&auto=format&fit=crop" className="w-full h-full object-cover" alt="Header" />
         </div>
         <div className="relative z-10">
            <h1 className="text-5xl md:text-7xl font-serif font-bold mb-4 drop-shadow-lg">Gallery Pinterest</h1>
            <div className="flex justify-center items-center gap-3 text-xs md:text-sm font-bold tracking-widest uppercase text-gray-200">
                <span className="hover:text-brand-red cursor-pointer transition-colors" onClick={onBack}>Home</span>
                <span>/</span>
        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-16">
            {categories.map((cat) => (
                <button
                    ...
                    className={`relative px-6 py-3 text-[11px] md:text-xs font-bold uppercase tracking-widest transition-all duration-300 rounded-sm ${
                        filter === cat 
